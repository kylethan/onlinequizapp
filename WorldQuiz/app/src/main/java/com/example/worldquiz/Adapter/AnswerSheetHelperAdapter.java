...
import com.example.worldquiz.Interface.IRecyclerHelperClick;
...
public class AnswerSheetHelperAdapter extends RecyclerView.Adapter<AnswerSheetHelperAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.activity_answer_sheet_helper_adapter,viewGroup,false);
